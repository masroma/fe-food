<template>
    <div class="bg-white shadow-lg p-5 py-10">
      <div class="flex justify-between">
        <p class="text-lg font-semibold">Edit Products</p>
      </div>
      <div class="container mx-auto my-5" v-if="!showLoader">
        <form @submit.prevent="updateProduct">
          <div class="flex flex-col mb-4">
            ...
            />
            <span class="text-red-700" v-if="validation.title">
              {{ validation.title[0] }}</span
            >
          </div>
          <div class="flex flex-col mb-4">
            ...
            <div class="flex">
              ...
              <div class="w-1/2 pl-2">
                ...
                :src="`${imageUrl}/products/${product.image_1}`"
                alt="belum ada gambar"
                class="w-16 h-16 object-cover mb-2"
              >
              ...
              <div class="w-1/2 pl-2">
                ...
                :src="`${imageUrl}/products/${product.image_2}`"
                alt="belum ada gambar"
                class="w-16 h-16 object-cover mb-2"
              >
              ...
              <div class="w-1/2 pl-2">
                ...
                :src="`${imageUrl}/products/${product.image_3}`"
                alt="belum ada gambar"
                class="w-16 h-16 object-cover mb-2"
              >
              ...
              <div class="w-1/2 pl-2">
                ...
                :src="`${imageUrl}/products/${product.image_4}`"
                alt="belum ada gambar"
                class="w-16 h-16 object-cover mb-2"
              >
          ...
          <div class="flex flex-col mb-4">
            <label for="nama product" class="block text-gray-700 text-sm mb-2"
              >Category</label
            >
            <select class="py-2 shadow  bg-white border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline focus:shadow-outline" v-model="product.category_id">
          ...
          <div class="flex flex-col mb-4">
            <label for="nama product" class="block text-gray-700 text-sm mb-2"
              >Berat <span class="text-xs">(dalam gram)</span></label
            >
            <input
              type="number"
              id="name"
  ...
  export default {
    ...
    mounted() {
        ...
        this.product.image       = this.$store.state.admin.product.product.image
        this.product.image_1       = this.$store.state.admin.product.product.image_1
        this.product.image_2       = this.$store.state.admin.product.product.image_2
        this.product.image_3       = this.$store.state.admin.product.product.image_3
        this.product.image_4       = this.$store.state.admin.product.product.image_4
