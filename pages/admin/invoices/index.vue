<template>
    <div class="bg-white shadow-lg p-5 py-10">
     <div class="flex justify-between">
      <p class="text-lg font-semibold">Tagihan</p>
      <nuxt-link :to="{name: 'admin-invoices-create'}" class="bg-blue-500 py-2 text-white rounded cursor-pointer px-5 flex gap-2">
